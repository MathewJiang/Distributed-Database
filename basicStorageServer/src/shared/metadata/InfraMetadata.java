...
public class InfraMetadata {
	...
	private List<ServiceLocation> serverLocations;
	
	public InfraMetadata() {
		 serverLocations = new ArrayList<ServiceLocation>();
	}
	...
	public void addServiceLocation(ServiceLocation sl) {
		this.serverLocations.add(sl);
	}
}
